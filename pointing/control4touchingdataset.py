...
class ControlAgentForTouchingDataset(Agent):
    
    def init(self):
        self.arm_dofs = ['r_shoulder_z', 'r_shoulder_y', 'r_arm_x', 'r_elbow_y', 'r_wrist_z', 'r_wrist_x']
...
self=ControlAgentForTouchingDataset()
