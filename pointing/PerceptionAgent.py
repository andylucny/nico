...
class PerceptionAgent(Agent):
    ...
    def senseSelectAct(self):
        ...
        _, points, dino_features = dino(frame)
        
        clip_features = image_clip(frame)
        ...
        space(validity=0.5)[self.nameFeatures] = clip_features
        space(validity=0.5)[self.namePoints[:4]+self.nameFeatures[4:]] = dino_features
