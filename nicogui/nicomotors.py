...
#0,  55,  100,   87,    0,  80, 50,   0,   0,   0
    ...
    joints = {  # 'key'       : [ DXL_ID, [dg0,bin0,coef] dg=dg0+coef*(bin-bin0), [bin-from,bin-default,bin-to], [(dg,bin,name)], [MinDg, MaxDg, MinDg, MaxDg, Inverted] ]
        ...
        'left-arm3'           : [  4, [0,1550,0.0865],   [1219,1980,1980], [(-45,1000,'up-sideway'),(0,1550,'straight'),(45,2020,'down-attach')], [ -118,  87, -140, 100, True ] ],
        ...
        'right-arm3'          : [  3, [0,2460,-0.0865],  [2052,2060,2880], [(-45,3140,'up-sideway'),(0,2460,'straight'),(45,2050,'down-attach')], [ -118,  87, -140, 100, True ] ],
